...
export default function CreateDestination({ title, user }: CreateDestinationProps) {
    const { data, setData, post, processing, errors } = useForm({
        ...
        latitude: '',
        longitude: '',
        popular_routes: [] as string[],
        distance_from_guwahati: '',
        estimated_travel_time: '',
        best_time_to_visit: [] as string[],
            ...
            <div className="bg-white shadow rounded-lg">
                <div className="px-4 py-5 sm:p-6">
                    <div className="flex justify-between items-center mb-6">
                        <h2 className="text-lg font-medium text-gray-900">Create New Destination</h2>
                        <Link
