                        ...
                        <div className="bg-white overflow-hidden shadow rounded-lg">
                            <div className="px-4 py-5 sm:p-6">
                                ...
                                <div className="space-y-3">
                                    {my_tours.length > 0 ? (
                                        my_tours.map((tourDriver) => (
                                            <div key={tourDriver.id} className="border rounded-lg p-4">
                                                <h4 className="font-medium text-gray-900">{tourDriver.tour.name}</h4>
                                                <p className="text-sm text-gray-500">
                                                    {new Date(tourDriver.tour.start_date).toLocaleDateString()} - {new Date(tourDriver.tour.end_date).toLocaleDateString()}
                                                </p>
                                                <p className="text-sm text-gray-500">{tourDriver.tour.description}</p>
                                            </div>
                                        ))
                                    ) : (
